...
<body>
  <nav class="maroon" role="navigation">
    <div class="nav-wrapper container">
      <a id="logo-container" href="#" class="brand-logo"><img src="" height="62" width="75" alt="Logo"> </img></a>
  ...
  <div class="container ">
	...
	%>
         <% while(resultset.next()){ %>
				<h4><a href=" <% out.println(resultset.getString(1)); %>" ><% out.println(resultset.getString(2)); %></a></h4>
			 <% } %>
			</p>
          </div>
        </div></div></div>
